...
if __name__ == '__main__':
    ...
    print("\nGenerate Densepose image using detectron2 library\n")
    terminnal_command ="python detectron2/projects/DensePose/apply_net.py show detectron2/projects/DensePose/configs/densepose_rcnn_R_50_FPN_s1x.yaml \
    https://dl.fbaipublicfiles.com/densepose/densepose_rcnn_R_50_FPN_s1x/165712039/model_final_162be9.pkl \
    origin.jpg dp_segm --output densepose.jpg -v"
    os.system(terminnal_command)
    terminnal_command ="python get_densepose.py"
    os.system(terminnal_command)
    
    #Get openpose skeleton image using pytorch-openpose
    print("Get openpose skeleton image\n")
    os.chdir("./pytorch-openpose")
    terminal_command = "python demo.py"
    os.system(terminal_command)
    os.chdir("../")
    
    #Generate parse_agnostic image
    terminnal_command = "python get_parse_agnostic.py"
    os.system(terminnal_command)
    
    #Generate human agnostic image
    terminnal_command = "python get_human_agnostic.py"
    os.system(terminnal_command)
    ...
    print("\nRun HR-VITON to generate final image\n")
    os.chdir("./HR-VITON")
    terminnal_command = "python test_generator.py --occlusion --test_name test1 --tocg_checkpoint ./eval_models/tocg/mtviton.pth --gpu_ids -1 --gen_checkpoint ./eval_models/gen/gen.pth --datasetting unpaired --data_list t2.txt --dataroot ./test" 
    os.system(terminnal_command)
